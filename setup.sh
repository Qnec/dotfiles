...
sudo apt install --no-install-recommends amd64-microcode firmware-linux firmware-realtek piper libncurses-dev mesa-utils mesa-utils-extra mesa-vulkan-drivers mesa-va-drivers mesa-vdpau-drivers git
...
#themes
echo themes
sudo apt install --no-install-recommends arc-theme faba-icon-theme
#fonts
echo fonts
